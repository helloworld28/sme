   ...
   <div class="am-cf am-padding">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-12">
				<ol class="property-list testDomain">
				 ...
				 <div class="am-form-group">
		            ...
		            <div class="am-margin">
		          <g:form url="[resource:testDomainInstance, action:'delete']" method="DELETE">
					<g:link class="am-btn am-btn-primary am-btn-xs edit" action="edit" resource="${testDomainInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
