 ...
 <div class="admin-content">
   <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg"><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a>
			...
			<g:hasErrors bean="${priceRuleInstance}">
			
					<g:eachError bean="${priceRuleInstance}" var="error">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-12">
         	<g:form class="am-form am-form-horizontal" url="[resource:priceRuleInstance, action:'save']" >
				<fieldset class="form">
				 ...
				 <div class="am-form-group">
		            ...
		            <div class="am-margin">
		            <g:submitButton name="create"  class="am-btn am-btn-primary am-btn-xs"value="${message(code: 'default.button.create.label', default: 'Create')}" />
