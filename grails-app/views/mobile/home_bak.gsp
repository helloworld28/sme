...
<body>
	...
	<div data-role="page" id="page_home">
		...
		<div data-role="main" class="ui-content">
			...
			<label><span>${session.member?.name }，欢迎您</span>&nbsp;<a href="#" onclick ="toPage('#page_updatepwd')">修改密码</a></label>
			</div>
				...
				<div class="ui-field-contain">
					...
					<div class="ui-grid-b" style="margin-bottom: 20px">
						<div class="ui-block-a" style="width: 30%; text-align: center;">
							<a href="<g:createLink  controller="mobile" action="xzDetail"/>"style="vertical-align: middle;font-weight:normal;color:#000000" >险种<img style="vertical-align: middle;" src="${resource(dir:'images',file:'detail.gif') }"/></a></div>
