...
<%@ page import="com.cpic.sme.Mobile" %>
<!DOCTYPE html>
<html>
	<head>
		<meta name="layout" content="main">
		<g:set var="entityName" value="${message(code: 'mobile.label', default: 'Mobile')}" />
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-12">
				<ol class="property-list mobile">
				 ...
				 <div class="am-form-group">
		            ...
		            <div class="am-margin">
		          <g:form url="[resource:mobileInstance, action:'delete']" method="DELETE">
					<g:link class="am-btn am-btn-primary am-btn-xs edit" action="edit" resource="${mobileInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
