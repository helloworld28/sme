      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
            ...
            <tr>
            	<g:each in="\${${propertyName}List}" status="i" var="${propertyName}">
					...
					<td><input type="checkbox" name="checkbox" value="\${${propertyName}.id}" /></td>
					...
					<%      } else if (i < 6) {
						...
						<td><g:formatBoolean boolean="\${${propertyName}.${p.name}}" true="是" false="否"/></td>
          ...
          <div class="am-cf">
			  ...
			  共\${${propertyName}Count ?: 0}条记录
			  <div class="am-fr">
			    <ul class="am-pagination pagination">
			        <g:paginate next="下一页" prev="上一页"
		            maxsteps="0" controller="${className}"
		            action="list" total="\${${propertyName}Count ?: 0}" />
