...
private renderFieldForProperty(p, owningClass, prefix = "") {
	...
	if (display) { %>
<div class="am-form-group fieldcontain \${hasErrors(bean: ${propertyName}, field: '${prefix}${p.name}', 'error')} ${required ? 'required' : ''}">
	<label class="am-u-sm-3 am-form-label" for="${prefix}${p.name}">
